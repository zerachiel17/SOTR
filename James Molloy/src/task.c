...
void initialise_tasking()
{
    ...
    current_task->next = 0;
// ONLY_IN_PRUEBA_29_NOT_IN_PRUEBA_28
...
monitor_write("Now We are in fork 1");
monitor_write("\n");
#endif
...
#ifdef PRINTING_DEBUG
monitor_write("Now We are in fork 2");
monitor_write("\n");
#endif
...
#ifdef PRINTING_DEBUG
monitor_write("Now We are in fork 3");
monitor_write("\n");
#endif
...
#ifdef PRINTING_DEBUG
monitor_write("Now We are in fork 4");
monitor_write("\n");
#endif
...
//
    new_task->next = 0;
#ifdef PRINTING_DEBUG
monitor_write("Now We are in fork 5");
monitor_write("\n");
#endif
...
#ifdef PRINTING_DEBUG
monitor_write("Now We are in fork 6");
monitor_write("\n");
#endif
    ...
    u32int eip = read_eip();
#ifdef PRINTING_DEBUG
monitor_write("Now We are in fork 7");
monitor_write("\n");
#endif
    ...
    {
#ifdef PRINTING_DEBUG
monitor_write("Now We are in fork 8");
monitor_write("\n");
#endif
    ...
    {
#ifdef PRINTING_DEBUG
monitor_write("Now We are in fork 9");
monitor_write("\n");
#endif
